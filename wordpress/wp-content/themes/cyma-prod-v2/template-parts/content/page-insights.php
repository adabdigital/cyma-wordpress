<?php
$bg = get_template_directory_uri() . '/assets/images/bg-insights1.webp';
?>
<section class="section-78" style="background-image:url('<?php echo esc_url( $bg ); ?>');background-size:contain;background-position:bottom right;background-repeat:no-repeat">
