          ...
          <nav role="navigation" class="nav-menu-wrapper w-nav-menu">
            <ul role="list" class="nav-menu-two w-list-unstyled">
              ...
              <li class="list-item-32">
                <a href="<?php echo _u('a738b12fc','link'); ?>" aria-current="page" class="nav-link-copy _1 new-color2" data-text="tn15a310e4" data-link="a738b12fc"><?php echo _u('tn15a310e4','text'); ?></a>
                <a href="<?php echo _u('a738b12fc','link'); ?>" aria-current="page" class="w-inline-block" data-link="a738b12fc"><img src="<?php echo cyma_get_image(_u('in56820f15', 'img'))->src ?>" loading="lazy" alt="<?php echo cyma_get_image(_u('in56820f15', 'img'))->alt ?>" class="image-219" data-img="in56820f15" srcset="<?php echo cyma_get_image(_u('in56820f15', 'img'))->srcset ?>"></a>
              </li>
  ...
  <section class="section-11" style="background-image:url('<?php echo get_template_directory_uri(); ?>/assets/images/bg-industries.webp');background-size:cover;background-position:center;background-repeat:no-repeat">
    ...
    <div class="w-layout-blockcontainer container-61 w-container">
      <div data-w-id="ea07a742-82ab-dcc6-edff-540c25c9f16f" style="opacity:0">
        <h1 class="heading-8 _1" data-textarea="tan369a81d6"><?php echo _u('tan369a81d6', 'textarea'); ?></h1>
        <p class="paragraph-7 _1" data-text="tna76f93b"><?php echo _u('tna76f93b','text'); ?></p>
        <div class="div-block-1091 lets-talk">
          <a href="<?php echo _u('a-7ed2abb3','link'); ?>" class="contact-btn-copy-industry-copy-ind lets-talk-copy-ind-copy-1 w-inline-block" data-link="a-7ed2abb3">
            <div class="text-block" data-text="tn6f7bcf81"><?php echo _u('tn6f7bcf81','text'); ?></div><img loading="lazy" src="<?php echo cyma_get_image(_u('in4da69620', 'img'))->src ?>" alt="<?php echo cyma_get_image(_u('in4da69620', 'img'))->alt ?>" class="image" data-img="in4da69620" srcset="<?php echo cyma_get_image(_u('in4da69620', 'img'))->srcset ?>">
          </a>
        </div>
      </div>
    </div>
  ...
  <section class="section-12">
    <div class="w-layout-blockcontainer container-14 w-container">
      <h2 data-w-id="d656c6bd-80b9-5223-2bb3-6d95a894c3c1" style="opacity:0" class="heading-53" data-textarea="tan139087e2"><?php echo _u('tan139087e2', 'textarea'); ?></h2>
      <p data-w-id="d5477f4f-6d76-c328-cc96-5bac59898cca" style="opacity:0" class="paragraph-19" data-text="t6937945b"><?php echo _u('t6937945b','text'); ?></p>
      <div data-w-id="b8fe0855-dec6-816d-4f21-49e4adf11e03" class="w-layout-grid grid-9">
        <div data-w-id="646ace30-521f-890b-3b1e-56bb34110c25" class="div-block-1122"><img src="<?php echo cyma_get_image(_u('in64e9a720', 'img'))->src ?>" loading="lazy" alt="<?php echo cyma_get_image(_u('in64e9a720', 'img'))->alt ?>" class="image-39" data-img="in64e9a720" srcset="<?php echo cyma_get_image(_u('in64e9a720', 'img'))->srcset ?>">
          <div class="div-block-1414">
            <h5 class="heading-1" data-text="tn7468bdb7"><?php echo _u('tn7468bdb7','text'); ?></h5>
            <p class="paragaph--1" data-text="tn75f3bd69"><?php echo _u('tn75f3bd69','text'); ?></p>
          </div>
        </div>
        <div data-w-id="0af7fa7f-6aad-9fc8-d784-9f277a32f598" class="div-block-1122"><img src="<?php echo cyma_get_image(_u('in627c47fb', 'img'))->src ?>" loading="lazy" alt="<?php echo cyma_get_image(_u('in627c47fb', 'img'))->alt ?>" class="image-40" data-img="in627c47fb" srcset="<?php echo cyma_get_image(_u('in627c47fb', 'img'))->srcset ?>">
          <div class="div-block-1415">
            <h5 class="heading-1" data-text="tn493ed9ab"><?php echo _u('tn493ed9ab','text'); ?></h5>
            <p class="paragaph--1" data-text="tn3e39982"><?php echo _u('tn3e39982','text'); ?></p>
          </div>
        </div>
        <div data-w-id="850cfe9e-ef2d-2e9f-9319-54f8b168bd69" class="div-block-1122"><img src="<?php echo cyma_get_image(_u('in77e0885d', 'img'))->src ?>" loading="lazy" alt="<?php echo cyma_get_image(_u('in77e0885d', 'img'))->alt ?>" class="image-41" data-img="in77e0885d" srcset="<?php echo cyma_get_image(_u('in77e0885d', 'img'))->srcset ?>">
          <div class="div-block-1416">
            <h5 class="heading-1" data-text="tn5f0907c5"><?php echo _u('tn5f0907c5','text'); ?></h5>
            <p class="paragaph--1" data-text="t2d579c24"><?php echo _u('t2d579c24','text'); ?></p>
          </div>
        </div>
        <div data-w-id="52958cc9-b5cf-e25c-1161-b299a15ade6b" class="div-block-1122"><img src="<?php echo cyma_get_image(_u('in3b4502b5', 'img'))->src ?>" loading="lazy" alt="<?php echo cyma_get_image(_u('in3b4502b5', 'img'))->alt ?>" class="image-42" data-img="in3b4502b5" srcset="<?php echo cyma_get_image(_u('in3b4502b5', 'img'))->srcset ?>">
          <div class="div-block-1417">
            <h5 class="heading-1" data-text="tn437fa0f2"><?php echo _u('tn437fa0f2','text'); ?></h5>
            <p class="paragaph--1" data-text="tn429d733a"><?php echo _u('tn429d733a','text'); ?></p>
          </div>
        </div>
      </div>
    </div>
  ...
  <section class="section-13">
    <div class="w-layout-blockcontainer container-15 w-container">
      ...
      <div class="w-layout-grid grid-10" style="align-items:start">
        <div data-w-id="ad9e11ef-e80a-bf2d-ec17-8e45d50e5eb7" class="div-block-1123" style="flex-flow:column;height:auto;padding-bottom:20px"><img src="<?php echo cyma_get_image(_u('i2e8a0894', 'img'))->src ?>" loading="lazy" alt="<?php echo cyma_get_image(_u('i2e8a0894', 'img'))->alt ?>" class="image-44" style="display:none" data-img="i2e8a0894" srcset="<?php echo cyma_get_image(_u('i2e8a0894', 'img'))->srcset ?>"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/image-banking.webp" loading="lazy" alt="Banking" class="image-44-copy-mv" style="display:inline-flex;width:100%;max-width:none;height:auto;border-radius:15px;object-fit:cover" data-img="in31e0f96b">
        ...
        <div data-w-id="1a178e0c-6521-602a-0d58-1a8c1afbcf66" class="div-block-1123" style="flex-flow:column;height:auto;padding-bottom:20px"><img src="<?php echo cyma_get_image(_u('i27240a8', 'img'))->src ?>" loading="lazy" alt="<?php echo cyma_get_image(_u('i27240a8', 'img'))->alt ?>" class="image-44" style="display:none" data-img="i27240a8" srcset="<?php echo cyma_get_image(_u('i27240a8', 'img'))->srcset ?>"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/image-automotive.webp" loading="lazy" alt="Automotive" class="image-44-copy-mv" style="display:inline-flex;width:100%;max-width:none;height:auto;border-radius:15px;object-fit:cover" data-img="in42d1d447">
          <div class="div-block-1124" style="align-items:center;text-align:center;padding-top:15px">
        ...
        <div data-w-id="9ef98d99-b614-25e9-f6a2-e2ebf6d18c73" class="div-block-1123" style="flex-flow:column;height:auto;padding-bottom:20px"><img src="<?php echo cyma_get_image(_u('in5f816d3', 'img'))->src ?>" loading="lazy" alt="<?php echo cyma_get_image(_u('in5f816d3', 'img'))->alt ?>" class="image-44" style="display:none" data-img="in5f816d3" srcset="<?php echo cyma_get_image(_u('in5f816d3', 'img'))->srcset ?>"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/image-healthcare.webp" loading="lazy" alt="Healthcare" class="image-44-copy-mv" style="display:inline-flex;width:100%;max-width:none;height:auto;border-radius:15px;object-fit:cover" data-img="in42b5a545">
          <div class="div-block-1124" style="align-items:center;text-align:center;padding-top:15px">
        ...
        <div data-w-id="851d5a47-a038-2f10-58d4-7211c8a117db" class="div-block-1123" style="flex-flow:column;height:auto;padding-bottom:20px"><img src="<?php echo cyma_get_image(_u('i2c9fb3a4', 'img'))->src ?>" loading="lazy" alt="<?php echo cyma_get_image(_u('i2c9fb3a4', 'img'))->alt ?>" class="image-44" style="display:none" data-img="i2c9fb3a4" srcset="<?php echo cyma_get_image(_u('i2c9fb3a4', 'img'))->srcset ?>"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/image-manufacturing.webp" loading="lazy" alt="Manufacturing" class="image-44-copy-mv" style="display:inline-flex;width:100%;max-width:none;height:auto;border-radius:15px;object-fit:cover" data-img="in42a78dc4">
          <div class="div-block-1124" style="align-items:center;text-align:center;padding-top:15px">
        ...
        <div data-w-id="ff7e02e0-2448-0d20-8cae-b5429b158ac8" class="div-block-1123" style="flex-flow:column;height:auto;padding-bottom:20px"><img src="<?php echo cyma_get_image(_u('in178e2a36', 'img'))->src ?>" loading="lazy" alt="<?php echo cyma_get_image(_u('in178e2a36', 'img'))->alt ?>" class="image-44" style="display:none" data-img="in178e2a36" srcset="<?php echo cyma_get_image(_u('in178e2a36', 'img'))->srcset ?>"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/image-retail.webp" loading="lazy" alt="Retail" class="image-44-copy-mv" style="display:inline-flex;width:100%;max-width:none;height:auto;border-radius:15px;object-fit:cover" data-img="in42997643">
          <div class="div-block-1124" style="align-items:center;text-align:center;padding-top:15px">
        ...
        <div data-w-id="0ac66039-2bc7-2752-bb9f-7dc75a24a2d2" class="div-block-1123" style="flex-flow:column;height:auto;padding-bottom:20px"><img src="<?php echo cyma_get_image(_u('in22239bd', 'img'))->src ?>" loading="lazy" alt="<?php echo cyma_get_image(_u('in22239bd', 'img'))->alt ?>" class="image-44" style="display:none" data-img="in22239bd" srcset="<?php echo cyma_get_image(_u('in22239bd', 'img'))->srcset ?>"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/image-telecommunicatioin.webp" loading="lazy" alt="Telecommunicatioin" class="image-44-copy-mv" style="display:inline-flex;width:100%;max-width:none;height:auto;border-radius:15px;object-fit:cover" data-img="in428b5ec2">
          <div class="div-block-1124" style="align-items:center;text-align:center;padding-top:15px">
        ...
        <div data-w-id="a55ced21-a758-eebf-9469-3d958876309f" class="div-block-1123" style="flex-flow:column;height:auto;padding-bottom:20px"><img src="<?php echo cyma_get_image(_u('i7f131da0', 'img'))->src ?>" loading="lazy" alt="<?php echo cyma_get_image(_u('i7f131da0', 'img'))->alt ?>" class="image-44" style="display:none" data-img="i7f131da0" srcset="<?php echo cyma_get_image(_u('i7f131da0', 'img'))->srcset ?>"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/image-government.webp" loading="lazy" alt="Government" class="image-44-copy-mv" style="display:inline-flex;width:100%;max-width:none;height:auto;border-radius:15px;object-fit:cover" data-img="in427d4741">
          <div class="div-block-1124" style="align-items:center;text-align:center;padding-top:15px">
        ...
        <div data-w-id="5b9b4238-1386-a7dc-7d03-5746eb6064df" class="div-block-1123" style="flex-flow:column;height:auto;padding-bottom:20px;grid-column:1/3;max-width:50%;margin:0 auto"><img src="<?php echo cyma_get_image(_u('i1abb54b1', 'img'))->src ?>" loading="lazy" alt="<?php echo cyma_get_image(_u('i1abb54b1', 'img'))->alt ?>" class="image-44" style="display:none" data-img="i1abb54b1" srcset="<?php echo cyma_get_image(_u('i1abb54b1', 'img'))->srcset ?>"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/image-insurance.webp" loading="lazy" alt="Insurance" class="image-44-copy-mv" style="display:inline-flex;width:100%;max-width:none;height:auto;border-radius:15px;object-fit:cover" data-img="in426f2fc0">
          <div class="div-block-1124" style="align-items:center;text-align:center;padding-top:15px">
      ...
      <div class="w-layout-grid grid">
        <div class="div-block-6">
          ...
          <div class="w-layout-vflex flex-block-5">
            <a href="<?php echo _u('a738b12fc','link'); ?>" aria-current="page" class="link-block-3 w-inline-block" data-link="a738b12fc">
