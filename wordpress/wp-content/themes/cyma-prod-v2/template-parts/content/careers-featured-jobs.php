...
$dice_url  = function_exists( 'cyma_get_dice_jobs_url' ) ? cyma_get_dice_jobs_url() : 'https://www.dice.com/jobs?filters.clientBrandNameFilter=Cyma+Systems+Inc';
$has_jobs  = ! empty( $jobs );
$row_class = $has_jobs ? 'cyma-featured-jobs-row has-jobs' : 'cyma-featured-jobs-row';
?>
<div class="<?php echo esc_attr( $row_class ); ?>">
      ...
      <?php foreach ( $jobs as $index => $job ) : ?>
        ...
        <div class="<?php echo esc_attr( $slide_class ); ?>">
          <div class="div-block-1179">
            ...
            <a href="<?php echo esc_url( $dice_url ); ?>" target="_blank" rel="noopener noreferrer" class="featuredjobcontent-btn w-inline-block">
  ...
  <div class="cyma-dice-cta-card">
    <div class="cyma-dice-cta-card__body">
      <div class="cyma-dice-cta-card__badge">Open Roles</div>
      <h2 class="cyma-dice-cta-card__title">Find your next role on Dice</h2>
      <p class="cyma-dice-cta-card__text">Browse current CYMA openings and apply directly — roles updated as new positions go live.</p>
    </div>
    <a href="<?php echo esc_url( $dice_url ); ?>" target="_blank" rel="noopener noreferrer" class="cyma-dice-cta-card__btn">
      <span class="cyma-dice-cta-card__btn-label">View Open Roles on Dice</span>
      <img loading="lazy" src="<?php echo esc_url( $base . '/signupbtn.svg' ); ?>" alt="" class="cyma-dice-cta-card__btn-icon">
    </a>
  </div>
</div>
