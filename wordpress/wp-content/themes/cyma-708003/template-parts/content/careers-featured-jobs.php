        ...
        <div class="div-block-1179">
          ...
          <div class="div-block-1184">
            <div class="div-block-1183">
              <img src="<?php echo esc_url( $base . '/featuredjob1.png' ); ?>" loading="lazy" alt="" class="image-49">
              <img src="<?php echo esc_url( $base . '/featuredjob2.png' ); ?>" loading="lazy" alt="" class="image-50">
              <img src="<?php echo esc_url( $base . '/featuredjob3.png' ); ?>" loading="lazy" alt="" class="image-51">
              <img src="<?php echo esc_url( $base . '/featuredjob4.png' ); ?>" loading="lazy" alt="" class="image-52">
